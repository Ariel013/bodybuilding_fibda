...
5. **Validation automatique** (règle du 26/09, en cours de compétition) : dès que tous les bulletins officiels sont reçus et le délai des stagiaires écoulé, le résultat est calculé et validé sans intervention ; la manche suivante s'ouvre d'elle-même. Le chef garde la « Saisie papier et correction contrôlée » pour rectifier. Une éliminatoire dont les ex æquo à la frontière du quota exigent une décision reste en attente : « Valider les résultats sportifs » (chef uniquement) fige alors ce calcul comme résultat officiel et prépare les récompenses d'une finale. Si des ex æquo se trouvent à la frontière du quota d'une éliminatoire, le serveur répond « Le chef doit résoudre les ex æquo à la frontière du quota. » : cochez les athlètes dans « Qualification explicite si un arbitrage est requis », avec un motif si le quota est respecté au lieu d'admettre tous les ex æquo.
...
0. Sortir de l'ordre préétabli : dans le dossier d'une manche en attente (onglet **Compétition**), « Ouvrir hors ordre » (chef ou responsable) ouvre cette manche même si sa discipline ou sa phase n'est pas la suivante prévue. Jamais possible si une autre manche est ouverte, ni si ses participants ne sont pas encore connus (demi-finale source non validée). Le déroulé reprend ensuite son ordre normal.
1. Le programme se déroule discipline par discipline, dans l'ordre de passage des catégories, et dans chaque discipline phase par phase : toutes les éliminatoires, puis toutes les demi-finales, puis toutes les finales, puis le toutes catégories. Une finale ne s'ouvre jamais tant qu'une demi-finale de la même discipline n'est pas validée (règle FIBDA, identique en national et en international).
2. **Le toutes catégories se crée seul** dès que toutes les finales d'une discipline sont validées (un par discipline et par sexe) : il réunit le premier de chaque classe (classement officiel) et s'ouvre aussitôt comme une manche ordinaire (étape 10) ; l'ordre de passage des champions est tiré au sort et l'écran des coulisses peut l'afficher. Un seul vainqueur : la manche ne s'ouvre pas (« Un champion seul exige la confirmation du chef. ») ; ouvrez son dossier et touchez « Confirmer le toutes catégories » (chef uniquement). Un champion absent : « Déclarer absent » dans le dossier avant le premier bulletin. Une finale reste corrigeable tant que le toutes catégories n'a pas été ouvert ; ses champions sont alors recalculés.
3. Onglet **Récompenses** : cochez « Récompense préparée » puis « Récompense remise » sur chaque carte de classe (1er, 2e, 3e), et « Enregistrer la remise ». Panneau « Clôture des cycles de remise » : « Confirmer les remises des catégories ». Le serveur refuse tant qu'une finale de la discipline n'est pas validée (« Validez les résultats avant la fin des récompenses. »).
4. « Créer le toutes catégories » (onglet **Compétition**) ne sert plus qu'en secours, si la création automatique a été contournée : le serveur répond « Overall déjà constitué » quand il existe déjà.
...
7. Après les finales d'une discipline : le toutes catégories se crée seul et se juge, remises de classe puis toutes catégories dans **Récompenses**, puis « Terminer cette discipline » (voir « Récompenses et toutes catégories »).
...
2. Dès que toutes les finales de la discipline sont validées, le toutes catégories se crée et s'ouvre seul avec le premier de chaque classe ; il se juge comme une manche. Un seul champion : « Confirmer le toutes catégories » dans son dossier (chef uniquement). « Créer le toutes catégories » dans **Compétition** n'est qu'un secours.
